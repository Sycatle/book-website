...
class User{
    ...
    /* USER ACTIONS */
    public function login(){ return $this->userManager->loginUser($this->username, $this->password); }
    public function register(){ return $this->userManager->registerUser($this->firstname,$this->lastname,$this->username,$this->email,$this->password); }
    ...
    public function getAvatarUrl(){ return './uploads/users/avatars/'. $this->username . '.webp'; }
    public function getBannerUrl(){ return './uploads/users/banners/'. $this->username . '.webp'; }
    ...
    public function setLastSeen($lastSeen) { $this->lastSeen = $lastSeen; }
    public function setBirthDate($birthDate) { $this->birthDate = $birthDate; }
    public function setAvatar($avatar) { /* TO DO */ }
    public function setBanner($banner) { /* TO DO */ }
}