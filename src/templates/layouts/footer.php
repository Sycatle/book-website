	    ...
	    <div class="row">
	        <div class="col-lg-3">
	            <div class="lc-block mb-4">
	                <img class="brand-icon" alt="logo" src="./assets/img/dark/brand_icon.svg" style="max-height:10vh">
                    <img class="brand-text" alt="logo" src="./assets/img/dark/brand_text.svg" style="max-height:10vh">
	            </div>
