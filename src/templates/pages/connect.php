...
<section class="container">
	...
	<form class="form-group py-4 mx-auto col-6" method="POST" name="register">
		<label>Nom d'utilisateur:</label>
		<input type="text" name="username" class="form-control" placeholder="Entrer votre nom d'utilisateur" required>
		<label>Prénom:</label>
		<input type="text" name="name" class="form-control" placeholder="Entrer votre prénom" required>
		<label>Nom de famille:</label>
		<input type="text" name="surname" class="form-control" placeholder="Entrer votre nom de famille" required>
