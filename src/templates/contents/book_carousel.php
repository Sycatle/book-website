<div class="sliding-section">
    <p class="title"><?= $sliderTitle ?></p>
    <div class="carousel book-carousel" data-flickity='{ "wrapAround": true, "autoPlay": <?= $sliderRate ?>  }'>
        <?php foreach ($searchedBooks as $book) {  ?>
            <div class="book-cell text-center bebl-<?= $book['gender_color'] ?>-border">
