    ...
    <div class="carousel book-carousel row" height="200px" data-flickity='{ "wrapAround": true, "cellAlign": "left", "dragThreshold": "30", "pageDots": false, "resize": true, "autoPlay": <?= $sliderRate ?>  }'>
        <?php foreach ($searchedBooks as $book) {  ?>
            <div class="book-cell d-flex">
                <a href="./?r=book&slug=<?= $book['book_slug'] ?>" title="<?= $book['book_title'] ?>"><img class="cell-image" src="./uploads/books/<?= $book['book_slug'] ?>.webp"></a>
                <div class="cell-content w-100">
                    <div class="cell-header d-flex my-2 row">
                        <p class="cell-title col-10 d-flex my-auto">
                            <a href="./?r=book&slug=<?= $book['book_slug'] ?>" title="<?= $book['book_title'] ?>"><?= $book['book_title'] ?></a>
                        </p>
                    ...
                    <div class="d-flex flex-column">
                        <div class="book-author my-2">
                            <a href="./?r=author&slug=<?= $book['author_slug'] ?>" title="<?= $book['author_name'] ?>">
                                Par <?= $book['author_name'] ?>
                            </a>
                        </div>
                        <div class="book-gender my-2">
                            <a class="rounded-pill" href="./?r=gender&slug=<?= $book['gender_slug'] ?>" title="<?= $book['gender_name'] ?>">
                                <?= $book['gender_name'] ?>
                            </a>
                        </div>
                    </div>
                    <div class="cell-footer justify-content-center align-items-center mt-auto mx-auto">
                        ...
                        <a href="./?r=book&slug=<?= $book['book_slug'] ?>" class="btn-access mx-1" title="Accéder">
                            Accéder
